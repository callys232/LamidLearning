  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-sm font-medium text-text-primary">Card number</label>
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
            ...
            {cardBrand && <span className="text-xs font-medium text-text-secondary">{cardBrand}</span>}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-text-primary">Expiry</label>
          <input
            value={expiry}

...
import {
  LayoutDashboard, BookOpen, Layers, Calendar, Award, BarChart3,
  Settings, Users, PenSquare, Globe, Building2,
  type LucideIcon,
} from "lucide-react";
...
export function NavLink({ label, href, icon }: NavLinkProps) {
  ...
  return (
    ...
    >
      ...
      {active && <span className="h-1.5 w-1.5 rounded-full bg-primary animate-scale-in" />}
    </Link>
  );
}

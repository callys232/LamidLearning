...
const badgeVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        default:  "bg-surface-active text-text-secondary border border-border hover:border-border-strong",
        primary:  "bg-primary-muted text-primary border border-primary/20 hover:bg-primary/20",

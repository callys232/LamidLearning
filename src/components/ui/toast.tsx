...
const variantConfig: Record<ToastVariant, { icon: typeof CheckCircle2; classes: string }> = {
  ...
  warning: { icon: AlertTriangle,  classes: "border-yellow-500/30 bg-yellow-500/10 text-yellow-400" },
      ...
      {toasts.map((t) => {
        ...
        return (
          ...
          >
            ...
            <span className="flex-1 text-text-primary text-xs leading-snug">{t.message}</span>
            <button
              type="button"

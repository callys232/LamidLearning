      ...
      <div className="p-5">
        <div className="mb-3 flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-text-primary">We use cookies</p>
            <p className="mt-0.5 text-xs text-text-secondary leading-relaxed">
              We use cookies to personalise your learning experience, remember your preferences, and analyse platform usage.{" "}

...
export function StatsCard({ label, value, sub, icon: Icon, trend, accent, className }: StatsCardProps) {
  return (
    <Card
      className={cn(
          ...
          <div className="flex flex-col gap-1">
            ...
            <p
              className={cn(
                ...
                accent ? "text-primary" : "text-text-primary group-hover:text-white"
              )}
            >
              {value}
            </p>
          ...
          >
            <Icon
              className={cn(
                ...
                accent ? "text-primary" : "text-text-secondary group-hover:text-text-primary"
              )}
            />
          </div>
        </div>

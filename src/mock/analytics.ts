import type { CourseAnalytics, PlatformAnalytics, LearnerProgress } from "@/types";
...
export const mockLearnerProgress: LearnerProgress[] = [
  {
    ...
    quizAttempts: [
      { quizId: "quiz-001", selectedOptionId: "b", isCorrect: true, attemptedAt: "2026-04-10T10:00:00Z" },
      { quizId: "quiz-002", selectedOptionId: "c", isCorrect: true, attemptedAt: "2026-04-12T11:30:00Z" },
    ],
    percentComplete: 45,
    timeSpentMinutes: 74,

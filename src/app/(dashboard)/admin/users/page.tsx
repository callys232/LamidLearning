                      ...
                      <td className="px-5 py-3">
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          {user.verificationStatus === "pending" ? (
                            ...
                            <button type="button" className="rounded-md border border-border px-2.5 py-1 text-xs text-text-secondary hover:bg-surface-hover hover:text-text-primary transition-all">
                              Edit role
                            </button>
                          )}
                          <button type="button" className="rounded-md border border-red-900/40 px-2.5 py-1 text-xs text-red-400 hover:bg-red-900/20 transition-all">
                            Deactivate
                          </button>
                        </div>
                      </td>
